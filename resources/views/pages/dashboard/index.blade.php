...
<section class="d-flex flex-column gap-4">
    ...
    <div class="d-flex gap-4 flex-wrap">
      <div class="product-card">
        <img
          src="{{asset('./local.admin/assets/images/nike_red.png')}}"
          alt="Nike Red"
          width="260"
          height="180"
        />
      ...
      <div class="product-card">
        <img
          src="{{asset('./local.admin/assets/images/nike_airforce.png')}}"
          alt="Nike Airforce"
          width="260"
          height="180"
        />
      ...
      <div class="product-card">
        <img
          src="{{asset('./local.admin/assets/images/nike_kiger.png')}}"
          alt="Nike Kiger"
          width="260"
          height="180"
        />
  ...
  <section class="d-flex flex-column gap-4 mb-5">
    ...
    <div class="d-flex gap-4 flex-wrap">
      <div class="store-card">
        <img
          src="{{asset('./local.admin/assets/images/adidas.png')}}"
          alt="Adidas Store"
          width="410"
          height="100"
        />
        <div class="store-logo-wrapper">
          <div class="store-logo-circle">
            <img
              src="{{asset('./local.admin/assets/images/adidas_logo.png')}}"
              alt="Adidas Logo"
              class="store-logo"
            />
          </div>
        ...
        <div class="store-name">
          <div>
            <p class="title-store">
              Adidas Store
              <span
                ><img src="{{asset('./local.admin/assets/icons/ic_badge.svg')}}" alt="Icon Badge"
              /></span>
            </p>
      ...
      <div class="store-card">
        <img
          src="{{asset('./local.admin/assets/images/puma.png')}}"
          alt="Puma Store"
          width="410"
          height="100"
        />
        <div class="store-logo-wrapper">
          <div class="store-logo-circle">
            <img
              src="{{asset('./local.admin/assets/images/puma_logo.png')}}"
              alt="Puma Logo"
              class="store-logo"
            />
          </div>
